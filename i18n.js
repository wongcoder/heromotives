const i18n = {
    "en": {
        ...
        "hero.btn.book": "Wrench with Hiro! (Coming Soon)",
    ...
    "jp": {
        ...
        "hero.subtitle": "アリゾナから、ASE認定マスターメカニック＆ホンダ認定整備士がS2000のビルド、チューニング、実践的なDIY修理チュートリアルをお届けします。<strong>※近々アリゾナ州内でのローカル出張整備サービスも開始予定！</strong>",
        "hero.btn.learn": "詳細を見る",
        "hero.btn.youtube": "YouTubeチャンネル",
        "hero.btn.instagram": "Instagramをフォロー",
        "hero.btn.book": "Hiroと一緒に整備！ (準備中)",

        "about.badge": "マスターテック",
        "about.badge.sub": "ホンダ ＆ トヨタ",
        "about.title": "メカニック紹介",
        "about.quote": "「自分の仕事に熟練した人を見よ。その人は王たちの前に立つ。」 – 箴言 22:29",
        "about.p1": "こんにちは、Hiroです。ASEマスターメカニック、ホンダ認定整備士、そしてトヨタのエキスパート認定資格を持っています。このチャンネルでは、アメリカのアリゾナ州から愛車のS2000ビルド、K24エンジンスワップ、Link G4X ECUのセッティング、そしてリアルなサーキット走行の様子を配信しています。",
        "about.p2": "さらに、実際の現場経験に基づいたDIY修理のチュートリアル、トラブルシューティング、整備士向けのプロのヒントを共有しています。車好きな方やメカニックを目指す方々が、より深く仕組みを理解し、最高の一台を造り上げ、走りを極めるサポートをするのが私の目標です。<br><br><b>【お知らせ】</b> まもなくアリゾナ州のローカル向けに、直接対面でのチューニングや整備サポートも開始予定です！",
        ...
        "card4.desc": "複雑な自動車システムの仕組み、エアロダイナミクス、パフォーマンスを極めるJDMビルドの設計思想を分かりやすく解説します。",

        "footer.motto": "深く理解し、最高の一台を造り、走りを極める。",
        "footer.social": "SNS ＆ お問い合わせ",
        "footer.specialties": "得意分野",
